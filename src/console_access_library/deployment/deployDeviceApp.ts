...
/**
 * This class implements DeviceApp deployment API.
 */
export class DeployDeviceApp {
    config: Config;
    api: DeviceAppApi;

    /**
     * Constructor Method for the class DeployDeviceApp
    ...
    /**
    * Schema for API to DeviceApp deployment.
    ...
    */
    async deployDeviceApp(
        ...
        try {
            ...
            const deployDeviceAppJsonBody: DeployDeviceAppJsonBody = {
                app_name: appName,
